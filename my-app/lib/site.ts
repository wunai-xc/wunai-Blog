...
export const SITE = {
  ...
  menu: {
    zh: [
      { name: "首页", href: "/zh/", icon: "mdi:home-outline" },
      { name: "文章", href: "/zh/posts/", icon: "mdi:file-document-outline" },
      { name: "搜索", href: "/zh/search/", icon: "mdi:magnify" },
    ...
    en: [
      ...
      { name: "Search", href: "/en/search/", icon: "mdi:magnify" },
